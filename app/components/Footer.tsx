...
export default function Footer({ translations }: FooterProps) {
  return (
    <footer className="py-3 px-4 flex items-center text-xs sm:text-sm border-t gap-4">
      <div className="flex-1 text-gray-500 hidden sm:block">{translations.footerText}</div>
      ...
      <div className="flex-1 flex justify-end gap-4">
        <a
          href="https://github.com/link2004/pdf2md"
          target="_blank"
          rel="noopener noreferrer"
